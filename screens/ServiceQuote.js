...
export default function ServiceQuote({ navigation }) {
        ...
        <View style={styles.wrapContent}>
            ...
            <View style={styles.main}>
                ...
                <View style={styles.wrapForm}>
                    ...
                    <View style={styles.formGroup}>
                        <Text style={[styles.textGroup, styles.textColor]}>Giá:</Text>
                        <Text style={[styles.textGroup, styles.textColor]}>100.000đ</Text>
                    </View>
                </View>
                <View style={styles.wrapBtn}>
                    <View style={styles.btnConfirm}>
                        <Button title="Xác nhận" color="white" onPress={() => navigation.navigate('SuccessfulRegistration')} />
                    </View>
                </View>
            </View>
        </View>
